...
\author {Jaka}
\insitute{Fakulteta za matematiko in fiziko}
\date {2025}    
\begin{document}   

\begin{frame}
    \titlepage
    \frametitle{Kazalo vsebine - Kratek pregled}
    \tableofcontents    
\end{frame}
\begin{frame}
    ...
    \end{frame}
\section {Uvod in priprava}
\subsection{Nastavitve okolja}  
\begin{frame}
    \frametitle{Prva prosojnica}
\end{frame}
\subsection{Osnovni ukazi}
\begin{frame}
    \frametitle{Druga prosojnica}
\end{frame}
